...
def main():
    ...
    for x in range(num_students):
        student_name = input("Please enter student # " + str(x+1) + " First and Last names: ")
        ...
        total = grade_1 + grade_2 + grade_3 + grade_4 + grade_5 + grade_6 + grade_7 + grade_8 + grade_9 + grade_10
    ...
    print(high_score_student_name + " has the highest student score! Score: " + str(high_score))
    print(low_score_student_name + " has the lowest student score! Score: " + str(low_score))
